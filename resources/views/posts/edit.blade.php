            ...
            <div class="card-body">
                ...
                <form action="/posts" enctype="multipart/form-data" method="POST" id="create-post-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control formInput @error('title') is-invalid @enderror formInput" value="{{ old('title', $post->title) }}">
                    ...
                    <div class="form-group row">
                        <div class="col-6 p-0 pr-2">
                            ...
                            <input type="number" name="price" id="price" class="form-control formInput @error('price') is-invalid @enderror" value="{{ old('price', $post->price) }}">
                    ...
                    <div class="form-group row">
                        <div class="col-6 p-0 pr-2">
                            ...
                            <input type="number" name="occurrence" id="occurrence" class="form-control formInput @error('occurrence') is-invalid @enderror" value="{{ old('occurrence', $post->occurrence) }}">
                    ...
                    <div class="form-group row">
                        <div class="col-6 p-0 pr-2">
                            ...
                            <input type="number" name="class_duration" id="class_duration" class="form-control formInput @error('class_duration') is-invalid @enderror" value="{{ old('class_duration', $post->class_duration) }}">
                    ...
                    <div class="form-group row">
                        <div class="col-6 p-0 pr-2">
                            ...
                            <input type="number" name="participants" id="participants" class="form-control formInput @error('participants') is-invalid @enderror" value="{{ old('participants', $post->participants) }}">
                    ...
                    <div class="form-group row">
                        <div class="my-2 tag-btn mr-2">
                            ...
                            <input type="datetime-local" name="schedule" id="schedule" class="form-control formInput @error('schedule') is-invalid @enderror" value="{{ old('schedule', $post->schedule) }}">
                        </div>
                    </div>
