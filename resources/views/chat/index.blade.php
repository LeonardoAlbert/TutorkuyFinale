                    ...
                    @endforeach
                        <!-- <li class="clearfix" id="5">
                            ...
                            <div class="about">
                                ...
                                <div class="status"> <i class="fa fa-circle offline"></i> verified </div>
                            </div>
                        </li>
                        <li class="clearfix active" id="7">
                            <img src="https://bootdey.com/img/Content/avatar/avatar2.png" alt="avatar">
                            <div class="about">
                                <div class="name">Aiden Chavez</div>
                                <div class="status"> <i class="fa fa-circle online"></i> verified </div>
                            </div>
                        </li>
                        <li class="clearfix">
